...
\begin{frame}[plain,c]
	...
	\begin{center}
	\Huge What is Multi-Agent Reinforcement Learning?\\
	\only<2>{\large \emph{Multiple} agents \textbf{learn} to take the \emph{right} actions (\textbf{policy}) to maximise a \emph{reward} signal.}
	\end{center}
\end{frame}
%/////////
...
\end{alertblock}
\end{frame}
\begin{frame}{Independent Q Learning~\footnote[frame]{\fullcite{DBLP:conf/icml/Tan93}}}
	...
	\end{columns}
\end{frame}
\begin{frame}{COMA~\footnote[frame]{\fullcite{DBLP:conf/icml/Tan93}}}
	\begin{itemize}
...
\end{frame}
\begin{frame}{Learning to Communicate ~\footnote[frame]{\fullcite{foerster2016learning}}}
	\begin{itemize}
...
\end{frame}
\begin{frame}{MAPPO~\footnote[frame]{\fullcite{yu2022surprising}}}
	\begin{itemize}
...
\end{frame}
\begin{frame}{Decentralised Hysteretic Deep-Recurrent-Q Learning~\footnote[frame]{\fullcite{omidshafiei2017deep}}}
	\begin{itemize}
...
\begin{frame}{Learning in Many Agent Systems}
	...
	\end{alertblock}
\end{frame}
\begin{frame}{Mean-field Reinforcement Learning~\footnote[frame]{\fullcite{yang2018mean}}}
	\begin{itemize}
